...
class MindstormsGadget(AlexaGadget):
    ...
    def __init__(self):
        ...
        self.head_motor = MediumMotor(OUTPUT_D)
    ...
    def on_alexa_gadget_musicdata_tempo(self, directive):
        ...
        for tempo in tempo_data:
            ...
            if tempo.value > 0:
                # dance pose
                self.head_motor.run_timed(speed_sp=50, time_sp=200)
                time.sleep(2)
                self.head_motor.run_timed(speed_sp=-50, time_sp=200)
                time.sleep(2)
                ...
                # self.head_motor.run_timed(speed_sp=-750, time_sp=2500)
                self.leds.set_color("LEFT", "GREEN")
                self.leds.set_color("RIGHT", "GREEN")
                time.sleep(3)
    ...
    def _dance_loop(self, bpm):
        ...
        while self.trigger_bpm == "on":
            ...
            self.head_motor.run_timed(speed_sp=motor_speed/4, time_sp=150)
